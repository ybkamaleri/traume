...
Tabellen viser andel og antall traumer som blir tatt i mot med traumeteam \newline
...
Figuren viser fordeling av antall og andel pasienter fordelt på ukedager i akuttmottak.\\

<<ukedager, fig.align='center', fig.height=4, fig.cap="Ukedager i akuttmottak">>=
## Ukedager
## ============
