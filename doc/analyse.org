...
** Tillegg ais
- Ryggsøyle (spine) tillegguttrekk under Cervicalcolumna. Skal det bare telles som
  det kodene eller må det også være mulig å sorterer etter alvorlighetsgrad?
* Outline
** Generelle Info
